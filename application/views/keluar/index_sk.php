        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-2 col-md-6 col-sm-12">
                        <a href="<?= base_url('keluar/create') ?>"
                            class="btn bg-gradient-primary mr-2 mt-1 btn-sm">Tambah Surat Keluar</a>
                    </div>
                    <div class="text-right ml-auto pr-2">
            ...
            <div class="card-body px-3 py-3 pb-2">
                <div class="table-responsive p-1">
                    <table class="table table-bordered table-striped table-hover table-sm" id="tbl-surat_keluar"
                        width="100%">
...
<script>
$(function() {
    let table = $('#tbl-surat_keluar').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    setTimeout(function() {
                        window.open("<?= base_url('keluar/print') ?>",
                            '_blank');
                    }, 1000);
                }
            },
        ...
        columns: [{
            ...
            render: function(data, type, row, meta) {
                return `<a href="<?= base_url('keluar/pdf/') ?>` + row.id_sp + `" 
                            class="badge bg-warning p-1" target="_blank">
                                <i class="fas fa-file-pdf"></i> Pdf</a>
                        <a href="<?= base_url('keluar/edit/') ?>` + row.id_sp + `" 
                            class="badge badge-info p-1"><i class="fas fa-edit"></i> Edit</a>
                        <a href="<?= base_url('keluar/delete/') ?>` + row.id_sp + `"
