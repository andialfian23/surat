...
<aside class="main-sidebar bg-navy elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="<?= base_url() ?>images/logo/logo.png" class="brand-image img-circle elevation-3  bg-white"
            style="opacity: 0.8" />
        <span class="brand-text font-weight-light">SURAT AKADEMIK</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php
                    ...
                    if ($role == 1) {
                        ...
                        $menu = $this->menu_model->menu_tu();
                    }else{
                        $menu = $this->menu_model->menu_mhs();
                    }
